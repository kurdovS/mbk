...
<div id="manage">
	...
	<table class="page_table">
		...
		<tr>
			...
			<td class="td_edit"><div class="td_div" contenteditable="true">' . $user['name'] . '</div></td>
			<td class="td_edit"><div class="td_div" contenteditable="true">' . $user['status'] . '</div></td>
			<td class="td_edit"><div class="td_div" contenteditable="true">' . $user['password'] . '</div></td>
			<td class="td_edit"><div class="td_div" contenteditable="false">' . $user['date'] . '<div></td>
			<td class="edit_user_butt"><div class="edit_user_button">Сохранить</div></td>
		</tr>';
		}
