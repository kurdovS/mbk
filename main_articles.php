	...
	for($i = 0; $i < $unp_max; $i++){
		...
		$html .= '
			<tr>
				...
				<td class="articles_table_regular_td_l"><div class="unrelease">Опубликовать</div></td>
			</tr>';
	}
	...
	for($i = 0; $i < $p_max; $i++){
		...
		$html .= '
			<tr>
				...
				<td class="articles_table_regular_td_l"><div class="release">Снять с публикации</div></td>
			</tr>';
	}
