	...
	if($maintance_num != 0)
		$html_code .= '
			<tr>
				...
				<td class="td_edit" contenteditable="true">' . $maintance['mt_header'] . '</td>
				<td class="td_edit" contenteditable="true">' . str_replace($search, $replace, $maintance['mt_description']) . '</td>
				<td class="td_edit" contenteditable="true">' . $maintance['deadline'] . '</td>
				<td><div id="edit_butt_save">Сохранить</div></td>
			</tr>';
	$html_code .= '
		</table>
	</div>';
